...
"""
Expectations (:mod:`aqua.operators.expectations`)
====================================================================

.. currentmodule:: aqua.operators.expectations
...
:class:`~aqua.operators.state_fns.OperatorStateFn` measurements with equivalent
...
a :class:`~aqua.operators.converters.CircuitSampler`. All in all, this would be:
...
such as :class:`~aqua.algorithms.VQE`, the algorithm can give the opportunity for the user

...
from aqua.utils.tensor_product import tensorproduct
...
def limit_paulis(mat, n=5, sparsity=None):
    ...
    from aqua.operators import MatrixOperator
    from aqua.operators.legacy.op_converter import to_weighted_pauli_operator

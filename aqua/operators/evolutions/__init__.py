...
"""
Operator Evolutions (:mod:`aqua.operators.evolutions`)
=============================================================

.. currentmodule:: aqua.operators.evolutions

Evolutions are converters which traverse an Operator tree, replacing any :class:`EvolvedOp` `e`
with a Schrodinger equation-style evolution :class:`~aqua.operators.primitive_ops.CircuitOp`
...
(not :mod:`~aqua.operators.state_fns`) have
...
Note:
    ...
    is an Operator, will produce a :class:`~aqua.operators.primitive_ops.CircuitOp`
    equivalent to e^iHt.
...
such as :class:`~aqua.algorithms.QAOA`, the algorithm can give the opportunity for the user

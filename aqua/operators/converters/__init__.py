...
"""
Converters (:mod:`aqua.operators.converters`)
====================================================

.. currentmodule:: aqua.operators.converters
...
a converter may accept :class:`~aqua.operators.primitive_ops.CircuitOp` and return a
:class:`~aqua.operators.list_ops.SummedOp` of
:class:`~aqua.operators.primitive_ops.PauliOp`'s representing the
...
:class:`~aqua.operators.expectations.MatrixExpectation` or
:class:`~aqua.operators.evolutions.MatrixEvolution`,
which convert :class:`~aqua.operators.primitive_ops.PauliOp`'s to
:class:`~aqua.operators.primitive_ops.MatrixOp`'s internally, will require time or space
exponential in the number of qubits unless a clever trick is known
(such as the use of sparse matrices).

Note:
     Not all converters are in this module, as :mod:`~aqua.operators.expectations`
     and :mod:`~aqua.operators.evolutions` are also converters.

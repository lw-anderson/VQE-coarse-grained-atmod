...
import numpy as np
from aqua.operators import OperatorBase, ListOp, CircuitOp
from aqua.operators.expectations import PauliExpectation
from aqua.operators.operator_globals import I, Z, Y, X, Zero
from aqua.operators.state_fns import StateFn, CircuitStateFn
...
class OverlapDiag(CircuitQFI):
    ...
    See also :class:`~aqua.operators.QFI`.
    """

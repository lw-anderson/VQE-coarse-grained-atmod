...
# from qiskit.providers import , JobStatus, JobError LEWIS: REMOVED ALL OCCURANCES OF BASE BACKEND
...
from aqua import MissingOptionalLibraryError
from aqua.aqua_error import AquaError
from aqua.utils.backend_utils import (is_aer_provider,
...
def run_qobj(qobj, backend, qjob_config=None, backend_options=None,
    ...
    if backend is None or not isinstance(backend, (Backend,)):
        raise ValueError('Backend is missing or not an instance of ')

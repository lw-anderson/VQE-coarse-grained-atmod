...
from aqua.operators import (OperatorBase, StateFn, Zero, One, CircuitStateFn,
                                   CircuitOp)
from aqua.operators import SummedOp, ListOp, ComposedOp, DictStateFn, VectorStateFn
from aqua.operators.gradients.circuit_gradients.circuit_gradient \
    import CircuitGradient
from aqua.operators.gradients.derivative_base import DerivativeBase

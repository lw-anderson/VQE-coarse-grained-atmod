...
r"""
Gradients (:mod:`aqua.operators.gradients`)
==================================================
...
callable and are thus compatible with the optimizers from `aqua.components.optimizers`.

.. currentmodule:: aqua.operators.gradients
